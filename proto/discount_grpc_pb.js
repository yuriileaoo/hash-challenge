...
const discount_pb = require("./discount_pb.js");
...
function deserialize_discount_GetDiscountRequest(buffer_arg) {
  return discount_pb.GetDiscountRequest.deserializeBinary(
...
function deserialize_discount_GetDiscountResponse(buffer_arg) {
  return discount_pb.GetDiscountResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}

// Service that return mocked discount percentage.
const DiscountService = (exports.DiscountService = {
  getDiscount: {
